...
$sql="SELECT * FROM tbl_enq WHERE fldCourse='$txtCourse' OR fldCourse='$txtCourse' AND fldDate >='$txtDate1' AND fldDate <='$txtDate'";
...
?>
	...
	<div >
			<a href="..\html\viewana.html"><button type="button"><span></span>Back</button></a>
     </div>
